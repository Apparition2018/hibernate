...
---
## Hibernate 开发基本步骤
1. [创建 Hibernate 配置文件](hibernate_/src/main/resources/hibernate.cfg.xml)
2. [创建持久化类](hibernate_/src/main/java/com/ljh/entity/News.java)
3. [创建对象/关系映射文件](hibernate_/src/main/resources/hbm/News.hbm.xml)
4. [使用 Hibernate API 访问数据库](hibernate_/src/test/java/com/ljh/HibernateTest.java)
---
...
### 映射关系
1. [映射组成关系](hibernate_/src/main/resources/hbm/component/Worker.hbm.xml)
2. 映射关联关系
    1. [单向多对一](hibernate_/src/main/resources/hbm/many2one/ua/Order.hbm.xml)
    2. [双向多对一/双向一对多](hibernate_/src/main/resources/hbm/many2one/ba/Customer.hbm.xml)
    3. [基于外键的一对一](hibernate_/src/main/resources/hbm/one2one/foreign/Department.hbm.xml)
    4. [基于主键的一对一](hibernate_/src/main/resources/hbm/one2one/primary/Department.hbm.xml)
    5. [单向多对多](hibernate_/src/main/resources/hbm/many2many/ua/Teacher.hbm.xml)
    6. [双向多对多](hibernate_/src/main/resources/hbm/many2many/ba/Teacher.hbm.xml)
3. 映射继承关系
    1. [subclass](hibernate_/src/main/resources/hbm/inheritance/subclass/Person.hbm.xml)
    2. [joined-subclass](hibernate_/src/main/resources/hbm/inheritance/joined.subclass/Person.hbm.xml)
    3. [union-subclass](hibernate_/src/main/resources/hbm/inheritance/union.subclass/Person.hbm.xml)
---
## Session
- 应用程序与数据库之间交互操作的一个单线程对象，是 Hibernate 的运作中心

### [Session 缓存](hibernate_/src/test/java/com/ljh/SessionCacheTest.java)
...
### [Session 方法](hibernate_/src/test/java/com/ljh/SessionMethodTest.java)
- 获取
...
### [管理 Session](hibernate_/src/test/java/com/ljh/SessionContextTest.java)
...
---
## [检索策略](hibernate_/src/test/java/com/ljh/QueryStrategyTest.java)
1. 类级别的检索策略，`<class/>`
    - lazy：是否延迟检索
        - false：立即检索
        - true：延迟检索
...
---
## [检索方式](hibernate_/src/test/java/com/ljh/QueryWayTest.java)
...
- 配置步骤
    ...
    ```
    2. [ehcache.xml](hibernate_/src/main/resources/ehcache.xml)（没有配置，则默认加载 ehcache-failsafe.xml）
### 查询缓存
- 使用步骤
    1. 配置二级缓存
    2. hibernate.cfg.xml
...
---
## [批量操作](https://www.bilibili.com/video/BV1KW411u7GJ/?p=25)
1. Session
